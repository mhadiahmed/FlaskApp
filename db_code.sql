...
-- articales table 
CREATE TABLE articale (id INT(11) AUTO_INCREMENT PRIMARY KEY,title VARCHAR(100),author VARCHAR(100),content TEXT,created TIMESTAMP DEFAULT CURRENT_TIMESTAMP,approve tinyint(1));